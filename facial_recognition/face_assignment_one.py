...
def plot_graph():
    ...
    ax[0].plot(df_etherium['close'], label='Etherium')
    ax[0].plot(df_etherium_classic['close'], label='Etherium Classic')
    ax[0].legend()
    ax[0].set_title('Etherium and Etherium Classic')
    ax[1].plot(df_etherium['close'], label='Etherium')
    ax[1].plot(df_etherium_classic['close'], label='Etherium Classic')
    ax[1].legend()
    ax[1].set_title('Etherium and Etherium Classic')
    plt.show()
